...
def bar_plot_multiple_checkpoints():
    ...
    analyzer.bar_plots_for_checkpoints(analyzer.olmo_predictions, "olmo", NEXT_TOKEN_NAME, OLMO_CHECKPOINTS, 8, 5, start_year, years_end)
    analyzer.bar_plots_for_checkpoints(analyzer.olmo_co_occurrence, "olmo", CO_OCCURR_NAME, OLMO_CHECKPOINTS, 8, 5, start_year, years_end)
    analyzer.bar_plots_for_checkpoints(analyzer.olmo_relative_ngram, "olmo", NGRAM_NAME, OLMO_CHECKPOINTS, 8, 5, start_year, years_end)
    analyzer.bar_plots_for_checkpoints(analyzer.pythia_predictions, "pythia", NEXT_TOKEN_NAME, PYTHIA_CHECKPOINTS, 2, 5, start_year, years_end)
    analyzer.bar_plots_for_checkpoints(analyzer.pythia_co_occurrence, "pythia", CO_OCCURR_NAME, PYTHIA_CHECKPOINTS, 2, 5, start_year, years_end)
    analyzer.bar_plots_for_checkpoints(analyzer.pythia_relative_ngram, "pythia", NGRAM_NAME, PYTHIA_CHECKPOINTS, 2, 5, start_year, years_end)
