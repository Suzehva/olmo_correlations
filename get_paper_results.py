from analyzer_class import (
    AnalyzerClass, 
    plot_cross_entropies_per_year_over_checkpoints, plot_average_cross_entropies_over_checkpoints, plot_cross_entropies, combine_images_original_sizes,
...
def try_different_system_prompts(analyzer):
    ...
    for model_name in ["meta-llama_llama-3.1-8b", "allenai_olmo-2-1124-7b", "allenai_olmo-2-0425-1b"]:
        layout = [
            [f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_The_current_date_is_{years[0]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_The_current_date_is_{years[0]}._In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_The_current_date_is_{years[1]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_The_current_date_is_{years[1]}._In__year__there_1950-2100.png"],
            [f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_Current_date:_{years[0]}In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_Current_date:_{years[0]}_In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_Current_date:_{years[1]}In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_Current_date:_{years[1]}_In__year__there_1950-2100.png"],
            [f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_Today_Date:_{years[0]}In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_Today_Date:_{years[0]}_In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_Today_Date:_{years[1]}In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_Today_Date:_{years[1]}_In__year__there_1950-2100.png"],
            [f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_The_year_is_{years[0]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_The_year_is_{years[0]}._In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_The_year_is_{years[1]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_The_year_is_{years[1]}._In__year__there_1950-2100.png"],
            [f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_It_is_{years[0]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_It_is_{years[0]}._In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_instruct_Next-token_predictions_system_It_is_{years[1]}.In__year__there_1950-2100.png", f"{model_name}_checkpointfinal_Next-token_predictions_It_is_{years[1]}._In__year__there_1950-2100.png"],
        ]
...
if __name__ == "__main__":
    ...
    # [("meta-llama/Llama-3.1-8B", "meta-llama/Llama-3.1-8B-Instruct"), ("allenai/OLMo-2-1124-7B", "allenai/OLMo-2-1124-7B-Instruct"), ("allenai/OLMo-2-0425-1B", "allenai/OLMo-2-0425-1B-Instruct")]:
    models_for_prompts = ["meta-llama/Llama-3.1-8B", "meta-llama/Llama-3.1-8B-Instruct", "allenai/OLMo-2-1124-7B", "allenai/OLMo-2-1124-7B-Instruct", "allenai/OLMo-2-0425-1B", "allenai/OLMo-2-0425-1B-Instruct"]
    ce_over_system_prompt_years_olmo = []
    ce_over_system_prompt_years_pythia = []
    prompt_list = []
    for year in range(1950, 2050 + 1):
